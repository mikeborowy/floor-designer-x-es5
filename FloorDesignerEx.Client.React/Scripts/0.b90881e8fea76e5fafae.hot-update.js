	...
	var Stage = function (_React$Component) {
	    ...
	    _createClass(Stage, [{
	        ...
	        value: function initDraggable() {
	            ...
	            var draggable = new _Draggable.Draggable();
	        ...
	        value: function onKeyDown(evt) {
	            ...
	            if (evt.keyCode === 88) {
	                ...
	                _Draggable.Draggable.get("#stage-container").enable();
	        ...
	        value: function onKeyUp(evt) {
	            ...
	            if (evt.keyCode === 88) {
	                ...
	                _Draggable.Draggable.get("#stage-container").disable();
	            }
	        }
	        /*ON KEY UP/DOWN END*/
...
//# sourceMappingURL=0.b90881e8fea76e5fafae.hot-update.js.map