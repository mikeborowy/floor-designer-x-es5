...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stage = function (_React$Component) {
	    ...
	    function Stage(props) {
	        ...
	        _this.var = _this.state.currentZoom();
	
	        console.log("Stage", _this.var);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Workspace = function (_React$Component) {
	    ...
	    function Workspace(props) {
	        ...
	        _this.currentZoomVal2 = _this.currentZoomVal2.bind(_this);
	    ...
	    _createClass(Workspace, [{
	        ...
	        value: function currentZoomVal(zoomVal) {
	            ...
	            console.log("Workspace zoom", this.state.zoom);
	        }
	    }, {
	        key: 'currentZoomVal2',
	        value: function currentZoomVal2() {
	            //return zoomVal;
	
	            return this.state.zoom;
	
	            console.log("Workspace 2 zoom", this.state.zoom);
	        }
	    }, {
	        key: 'updateDimensions',
	        value: function updateDimensions() {
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(_stage2.default, { currentZoom: this.currentZoomVal2 })
	                )
	            );
	        }
	    }]);
...
//# sourceMappingURL=0.be2fe6e07f73c0b62e34.hot-update.js.map