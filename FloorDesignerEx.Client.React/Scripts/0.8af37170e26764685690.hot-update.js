...
/***/ function(module, exports, __webpack_require__) {
	...
	var Workspace = function (_React$Component) {
	    ...
	    _createClass(Workspace, [{
	        ...
	        //onZoomStage(stageScaleNum) {
	
	        //    this.setState({ stageScaleNum });
	        //    this.zoomStage();
	        //}
	        ...
	        value: function onZoomStage(zoom) {
	            ...
	            this.setState({ stageScaleNum: zoom });
	        ...
	        value: function onMouseWheel(evt) {
	            ...
	            if (this.zoomMouse) {
	                ...
	                if (delta > 0) {
	                    this.setStagestageScaleNum += 0.1;
	                } else {
...
//# sourceMappingURL=0.8af37170e26764685690.hot-update.js.map