	...
	var Stage = function (_React$Component) {
	    ...
	    _createClass(Stage, [{
	        ...
	        value: function stageInit() {
	            ...
	            (0, _jquery2.default)('#stage').width(this.state.floorCfg.width * this.state.roomsCfg.gridCellWidth);
	            (0, _jquery2.default)('#stage').height(this.state.floorCfg.height * this.state.roomsCfg.gridCellHeight);
	
	            (0, _jquery2.default)('#stage-items-container').width(floorCfg.width * this.state.roomsCfg.gridCellWidth);
	            (0, _jquery2.default)('#stage-items-container').height(floorCfg.height * this.state.roomsCfg.gridCellHeight);
...
//# sourceMappingURL=0.f66b5aa3a3257ffd3dbf.hot-update.js.map