	...
	var Workspace = function (_React$Component) {
	    ...
	    _createClass(Workspace, [{
	        ...
	        value: function updateZoom(zoomVal) {
	            ...
	            return this.setState({ zoom: zoomVal });
	        }
	    }, {
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(_toolbar2.default, { updateZoom: this.updateZoom, appCfg: this.props.appCfg }),
	                    React.createElement(_shapesPanel2.default, null),
	                    React.createElement(_stage2.default, { zoom: this.state.zoom, updateZoom: this.updateZoom })
	                )
	            );
	        }
	    }]);
...
//# sourceMappingURL=0.0270ba4a4ee0797f2434.hot-update.js.map