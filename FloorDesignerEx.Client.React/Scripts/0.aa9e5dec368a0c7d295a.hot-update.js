...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stageBoard = __webpack_require__(/*! ./stageBoard */ 209);
	
	var Board = _interopRequireWildcard(_stageBoard);
	
	var _stageBoardHighlight = __webpack_require__(/*! ./stageBoardHighlight */ 208);
	
	var BoardHighlight = _interopRequireWildcard(_stageBoardHighlight);
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        stageBoardsList.map(function (boardItem) {
	                            return React.createElement(BoardHighlight, {
	                                key: boardItem.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StageBoard = function StageBoard(props) {
	    var _props = undefined.props,
	        width = _props.width,
	        height = _props.height,
	        x = _props.x,
	    ...
	    return React.createElement("div", { className: "stage-board-field",
	        style: "position:absolute; border: 1px dashed rgba(0, 0, 0, 0.05); width:{width}; height:{height}; top:{y}, left: {x}; " });
	};
...
//# sourceMappingURL=0.aa9e5dec368a0c7d295a.hot-update.js.map