...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toolbar = function (_React$Component) {
	    ...
	    function Toolbar(props) {
	        ...
	        console.log("Toolbar", _this.appCfg);
	    ...
	    _createClass(Toolbar, [{
	        ...
	        */
	        ...
	        value: function onZoomSliderChange(evt) {
	            ...
	            if (this.debugMode) console.log("onZoomSliderChange", this);
	        ...
	        value: function onSaveFloorClick() {
	            ...
	            if (this.debugMode) console.log("onSaveFloorClick");
...
//# sourceMappingURL=0.609c13ae17d37a837b0e.hot-update.js.map