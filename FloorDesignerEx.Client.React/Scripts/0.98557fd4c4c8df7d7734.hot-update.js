...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toolbar = function (_React$Component) {
	    ...
	    function Toolbar(props) {
	        ...
	        _this.state = {
	            stageScaleNum: _this.stageScaleNum,
	            floorData: {}
	        };
	    ...
	    _createClass(Toolbar, [{
	        ...
	        value: function onZoomStage() {
	            ...
	            var _zoomCfg = this.zoomCfg,
	                stageScaleNum = _zoomCfg.stageScaleNum,
	                stageScaleNumMin = _zoomCfg.stageScaleNumMin,
	                stageScaleNumMax = _zoomCfg.stageScaleNumMax;
	        ...
	        */
	        ...
	        value: function onZoomSliderChange(evt) {
	            ...
	            var stageScaleNum = this.zoomCfg.stageScaleNum;
	
	            stageScaleNum = evt.target.value * 0.1 + 1;
	        ...
	        value: function onZoomOutClick(evt) {
	            ...
	            console.log(this.zoomCfg.stageScaleNum);
	        ...
	        value: function onZoomResetClick(evt) {
	            ...
	            this.setState({ stageScaleNum: this.stageScaleNum });
...
//# sourceMappingURL=0.98557fd4c4c8df7d7734.hot-update.js.map