	...
	var Stage = function (_React$Component) {
	    ...
	    _createClass(Stage, [{
	        ...
	        value: function zoomStage(evt) {
	            ...
	            if (this.stageScaleNum < stageScaleNumMin) {
	                this.stageScaleNum = stageScaleNumMin;
	            }
	            if (this.stageScaleNum > stageScaleNumMax) {
	                this.stageScaleNum = stageScaleNumMax;
	            }
...
//# sourceMappingURL=0.382438c4af03b499fde5.hot-update.js.map