	...
	var Toolbar = function (_React$Component) {
	    ...
	    function Toolbar(props) {
	        ...
	        _this.state = {
	            ...
	            //this.onZoomStage = this.props.currentZoom;
	    ...
	    */
	    ...
	    _createClass(Toolbar, [{
	        key: 'onZoomStage',
	        value: function onZoomStage(zoomVal) {
	            this.props.updateZoom(zoomVal);
	        }
	        ...
	        value: function onZoomSliderChange(evt) {
	            ...
	            this.props.updateZoom(this.stageScaleNum);
	            this.onZoomStage(this.stageScaleNum);
...
//# sourceMappingURL=0.f87584f65b60beda824d.hot-update.js.map