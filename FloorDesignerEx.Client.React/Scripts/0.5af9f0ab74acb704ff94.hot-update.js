	...
	var Workspace = function (_React$Component) {
	    ...
	    _createClass(Workspace, [{
	        ...
	        value: function onZoomStage(zoom) {
	            ...
	            console.log('onZoomStage', this.stageScaleNum);
	        ...
	        value: function zoomStage() {
	            ...
	            console.log('zoomStage', this.stageScaleNum);
	        ...
	        value: function onMouseWheel(evt) {
	            ...
	            if (this.zoomMouse) {
	                ...
	                this.zoomStage(this.stageScaleNum);
...
//# sourceMappingURL=0.5af9f0ab74acb704ff94.hot-update.js.map