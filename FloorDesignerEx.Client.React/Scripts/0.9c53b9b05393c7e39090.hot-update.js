	...
	var Stage = function (_React$Component) {
	    ...
	    _createClass(Stage, [{
	        ...
	        value: function initDraggable() {
	            ...
	            var draggableObj = _gsap.Draggable.create((0, _jquery2.default)("#stage-container"), {
	                type: "scroll",
	                edgeResistance: 1,
	                throwProps: true,
	                lockAxis: true
	            ...
	            _gsap.Draggable.get("#stage-container").disable();
	        }
	    }, {
	        key: 'loadItems',
	        ...
	        value: function onKeyDown(evt) {
	            ...
	            if (evt.keyCode === 88) {
	                ...
	                _gsap.Draggable.get("#stage-container").enable();
...
//# sourceMappingURL=0.9c53b9b05393c7e39090.hot-update.js.map