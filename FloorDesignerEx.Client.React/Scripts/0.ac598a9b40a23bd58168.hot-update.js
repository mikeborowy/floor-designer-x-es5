	    ...
	    _createClass(Toolbar, [{
	        ...
	        */
	        ...
	        value: function onZoomInClick(evt) {
	            ...
	            this.onZoomStage();
	            document.querySelector('#zoom-slider').MaterialSlider.change((this.state.stageScaleNum - 1) * 10);
	        }
	        ...
	        value: function onZoomOutClick(evt) {
	            ...
	            this.setState({ stageScaleNum: this.state.stageScaleNum - 0.1 });
	            this.onZoomStage();
	            document.querySelector('#zoom-slider').MaterialSlider.change((this.state.stageScaleNum - 1) * 10);
	        }
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    'button',
	                                    {
	                                        ...
	                                        onClick: this.onZoomResetClick.bind(this),
...
//# sourceMappingURL=0.ac598a9b40a23bd58168.hot-update.js.map