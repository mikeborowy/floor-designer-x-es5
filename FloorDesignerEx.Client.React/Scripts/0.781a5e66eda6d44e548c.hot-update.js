	    ...
	    _createClass(Workspace, [{
	        ...
	        value: function zoomStage() {
	            ...
	            TweenMax.to(stage, 0.3, {
	                scaleX: this.state.stageScaleNum,
	                scaleY: this.state.stageScaleNum
	            });
	
	            var posX = stageContainer.width() / 2 - stage.width() / 2;
	            var stageWidthAfterScale = stage.width() * this.state.stageScaleNum;
	
	            var posY = stageContainer.height() / 2 - stage.height() / 2;
	            var stageHeightAfterScale = stage.height() * this.state.stageScaleNum;
...
//# sourceMappingURL=0.781a5e66eda6d44e548c.hot-update.js.map