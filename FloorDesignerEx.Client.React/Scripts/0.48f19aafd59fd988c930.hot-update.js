	...
	var Stage = function (_React$Component) {
	    ...
	    _createClass(Stage, [{
	        ...
	        value: function render() {
	            var stageBoardsList = this.state.stageCfg.stageBoardsList.stageBoardsList;
	
	
	            console.log(this.state.stageCfg);
...
//# sourceMappingURL=0.48f19aafd59fd988c930.hot-update.js.map