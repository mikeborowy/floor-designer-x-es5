	...
	var Workspace = function (_React$Component) {
	    ...
	    _createClass(Workspace, [{
	        ...
	        value: function updateZoom(zoomVal) {
	            console.log("Workspace zoom", this.state.currentZoom);
	            this.setState({ currentZoom: zoomVal });
	        }
	    }, {
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(_stage2.default, { currentZoom: this.state.currentZoom })
	                )
	            );
	        }
	    }]);
...
//# sourceMappingURL=0.a4a51ddcbd0dada27962.hot-update.js.map