	...
	var Stage = function (_React$Component) {
	    ...
	    _createClass(Stage, [{
	        ...
	        value: function stageInit() {
	            ...
	            var draggableObj = _gsap2.default.Draggable.create((0, _jquery2.default)("#stage-container"), {
	                type: "scroll",
	                edgeResistance: 1,
	                throwProps: true,
	                lockAxis: true
...
//# sourceMappingURL=0.c1541968a08228515e09.hot-update.js.map