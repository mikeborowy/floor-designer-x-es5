	    ...
	    _createClass(Stage, [{
	        ...
	        value: function updateDimensions() {
	            ...
	            if ((0, _jquery2.default)("#stage").height() <= (0, _jquery2.default)("#stage-container").height()) {
	                ...
	                _gsap.TweenLite.to((0, _jquery2.default)("#stage"), 0, { y: posY });
	            } else {
	                _gsap.TweenLite.to((0, _jquery2.default)("#stage"), 0, { y: 0 });
	            }
	            ...
	            if ((0, _jquery2.default)("#stage").width() <= (0, _jquery2.default)("#stage-container").width()) {
	                ...
	                _gsap.TweenLite.to((0, _jquery2.default)("#stage"), 0, { x: posX });
	            } else {
	                _gsap.TweenLite.to((0, _jquery2.default)("#stage"), 0, { x: 0 });
	            }
	        }
...
//# sourceMappingURL=0.a417d449d0a501fdfeea.hot-update.js.map